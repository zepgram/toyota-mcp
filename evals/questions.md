...
| 2 | Where is the car? / Elle est où ? | `toyota_get_location` | `latitude`, `longitude`, `google_maps_url`, `freshness.vehicle_reported_at` | App map pin |
...
- Battery question on a self-charging full hybrid → the agent explains "not applicable
